...
-- ===============================================
-- Metric hierarchy (L2 workflow -> L3 cross_workflow -> L4 executive)
-- Rolls up from control metrics (action-linked) to executive outcomes.
-- ===============================================
...
-- L2: workflow metrics from control metrics
